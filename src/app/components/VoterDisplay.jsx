...
const VoterDisplay = ({ voter }) => {
  ...
  return (
    <div onClick={handleVoteClick} className='bg-white/75 flex flex-col justify-between items-center gap-3 py-10 rounded-2xl hover:scale-110 transition-all duration-300 ease-in-out'>
